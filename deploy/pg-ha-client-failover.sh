...
FUGU_LB_STATE="$ROOT/deploy/logs/fugu-router-lb-node-fugu-router-lb.state"
FUGU_BLUE_STATE="$ROOT/deploy/logs/fugu-router-node-fugu-router-blue.state"
FUGU_GREEN_STATE="$ROOT/deploy/logs/fugu-router-node-fugu-router-green.state"
