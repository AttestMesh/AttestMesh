# Webhost v1.1.17 node migration

This runbook promotes the existing `open-webhost` CVM to Webhost `v1.1.17`
...
for `dmvt/webhost-control` tag `v1.1.17`, source commit
`cfb2401afe762210d3738cc472fda84b0a098ad7`:

- control plane: `sha256:be4fbc00dd4075e96395a2354c14e20174d38bc007cd6dccdac30bc80602f5d5`;
- storage helper: `sha256:c24fd69bc6dfae25c24a5f95f703321957db92bac23ef80bc8fb67e7ddae66ac`;
- TLS proxy: `sha256:733e1ecc1ec436d3d3fc28482fff26e1141e167afd076dc72cb838457b8e9911`.
...
rollback topology, but the v1.1.17 control plane does not consume them. The
...
Webhost writer started. Before the v1.1.17 writer starts, the
